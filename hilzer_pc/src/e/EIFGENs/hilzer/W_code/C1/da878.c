...
extern EIF_TYPED_VALUE F878_7676(EIF_REFERENCE);
extern EIF_TYPED_VALUE F878_7677(EIF_REFERENCE);
extern EIF_TYPED_VALUE F878_7678(EIF_REFERENCE);
...
EIF_TYPED_VALUE F878_7676 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F878_7677 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F878_7678 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 877, Current, 0, 0, 12800);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(877, Current, 12800);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5443, "fractional_second", tr1));
